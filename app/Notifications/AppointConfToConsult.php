...
class AppointConfToConsult extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
                    ...
                    ->greeting('Hi '.$this->consultantDetail['first_name'])
                    ->line('A new Appointment has been scheduled with '.$this->appointment_details['name'])
