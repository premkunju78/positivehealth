  ...
  <b-card title="Create your Questionnaire">
    <validation-observer #default="{ handleSubmit }" ref="refFormObserver">
      <b-form ref="form" @submit.prevent="handleSubmit(onSubmit)">
        ...
        <b-row>
          <b-col md="4">
            <validation-provider #default="validationContext" name="mc-questionnaires-name" rules="required">
          ...
          <b-col md="4">
            <validation-provider #default="validationContext" name="mc-questionnaires-description" rules="">
              <b-form-group label="Questionnaire Description" label-for="mc-questionnaires-description">
                <b-form-input :state="
                  getValidationState(
                    validationContext
                  )
                " id="mc-questionnaires-description" :class="errors && errors.description ? 'is-invalid' : ''"
                  :area-invalid="errors && errors.description ? true : false" v-model="questionnaire.description"
          ...
          <b-col md="4">
            <validation-provider #default="validationContext" name="mc-questionnaires-type" rules="required">
              <b-form-group label="Form Type" label-for="mc-questionnaires-type">
                <v-select v-model="questionnaire.type" :dir="$store.state.appConfig.isRTL ? 'rtl' : 'ltr'"
                  :options="types" :reduce="(val) => val.label" :clearable="true" />
              </b-form-group>
            </validation-provider>
          </b-col>
        </b-row>
