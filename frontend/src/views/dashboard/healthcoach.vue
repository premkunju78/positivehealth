      ...
      <b-row>
        <b-col lg="8" sm="7">
          <b-row>
            ...
            <b-col md="12">
              <b-card title="Today's Appointments" style="height: 350px; overflow: auto">
                <TodaySchedule />
              </b-card>
            </b-col>
            <b-col md="12">
                ...
                <b-card-header class="align-items-baseline">
                  ...
                  <b-card-text class="mb-0">
                    <router-link :to="{ name: 'clients' }"
                      ><h5 class="text-info">View All</h5></router-link
                    >
                  </b-card-text>
                </b-card-header>
                <ClientList />
...
import { BRow, BCol, BCard, BCardText, BLink,BCardHeader,BCardTitle } from "bootstrap-vue";
...
export default {
  ...
  methods: {
    ...
    async callNow(coordinator) {
      try {
        const { data } = await axios.post(`/coordinator/call`, coordinator);
        this.$toast({
