      ...
      <b-row class="mb-1" >
        ...
        <b-col
          ...
          <div class="d-flex align-items-center justify-content-end">
            ...
            />
             <b-form-datepicker id="expiry_date" :class="error ? 'is-invalid' : ''" :min="new Date()" :date-format-options="{ year: 'numeric', month: 'numeric', day: 'numeric' }" v-model="data.expiry_date" placeholder="Expiry Date"></b-form-datepicker>
