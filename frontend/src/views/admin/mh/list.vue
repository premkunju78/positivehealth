        ...
        <b-row>
          ...
          <b-col cols="12" md="6">
            <div
              ...
              v-permission="['create-marketinghead']"
            >
              <!-- <b-form-input
                v-model="searchQuery"
                ...
                placeholder="Search..."
              /> -->
              <router-link :to="{ name: 'mh-create' }">
                <b-button variant="primary" v-permission="['create-marketinghead']">
                  <span class="text-nowrap">Add Marketting Head</span>
                </b-button>
              </router-link>
            </div>
          </b-col>
        ...
        <template #cell(actions)="data">
          <div class="text-nowrap">
            <b-dropdown
              ...
              v-permission="['edit-marketinghead']"
            >
  ...
  methods: {
    ...
    async deleteMh(mh) {
      if (confirm("Do you really want to delete?")) {
        try {
          let data;
          data = await axios.delete(`/mh/${mh.id}`);
          this.$toast({
            component: ToastificationContent,
            props: {
