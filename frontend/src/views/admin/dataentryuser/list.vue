        ...
        <b-row>
          ...
          <b-col cols="12" md="6">
            <div
              ...
              v-permission="['create-dataentryuser']"
            >
              <!-- <b-form-input
                v-model="searchQuery"
                ...
                placeholder="Search..."
              /> -->
              <router-link :to="{ name: 'dataentryuser-create' }">
                <b-button variant="primary" v-permission="['create-dataentryuser']">
                  <span class="text-nowrap">Add Data Entry user</span>
                </b-button>
              </router-link>
            </div>
          </b-col>
        ...
        <template #cell(actions)="data">
          <div class="text-nowrap">
            <b-dropdown
              ...
              v-permission="['edit-dataentryuser']"
            >
              ...
              <b-dropdown-item
                ...
                v-permission="['view-dataentryuser']"
              >
  ...
  methods: {
    async getList() {
      try {
        ...
        const { data } = await axios.get("/dataentryuser", {
          params: this.pagination,
        });
        console.log(data.dataentryuser);
        this.items = data.dataentryuser;
        ...
        toast({
          ...
          props: {
            title: "Error fetching dataentryuser list",
    ...
    async deleteMh(dataentryuser) {
      if (confirm("Do you really want to delete?")) {
        try {
          let data;
          data = await axios.delete(`/dataentryuser/${dataentryuser.id}`);
          this.$toast({
            component: ToastificationContent,
            props: {
