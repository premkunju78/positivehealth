  ...
  <div>
            ...
            >
              ...
              <router-link :to="{ name: 'healthcoach-create' }">
                <b-button variant="primary" v-permission="['create-healthcoaches']">
                  <span class="text-nowrap">Add Healthcoach</span>
                </b-button>
              </router-link>
            </div>
          </b-col>
          ...
          <b-row>
            <b-col cols="12" md="12">
              ...
              >
                <b-form-group
                  label="Select Leads"
                  label-for="healthcoaches"
                  :state="getValidationState(validationContext)"
                >
                  <v-select
                    v-model="userData.leads"
    ...
    >
      ...
      >
        ...
        <template #cell(actions)="data">
          <a
            @click="handleRemoveLead('healthcoach', data.item.healthcoach_lead_id)"
            v-permission="['edit-healthcoaches']"
