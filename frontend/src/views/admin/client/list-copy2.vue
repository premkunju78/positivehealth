    ...
    <b-card no-body class="mb-0">
          ...
          <b-col cols="12" md="6">
            <div v-if="!id" class="d-flex align-items-center justify-content-end" v-permission="['create-clients']">
              ...
              <router-link :to="{ name: 'client-create' }">
                <b-button variant="primary" v-permission="['create-clients']" v-if="$store.getters.user.role_id == 1">
      ...
      <b-col cols="12" md="6" class="d-flex align-items-center justify-content-start mb-1 mb-md-0"
        ...
        <ul class="nav nav-tabs nav-justified" id="myTab2" role="tablist">
          <li class="nav-item" v-if="($store.getters.user.role_id == 1 || $store.getters.user.role_id == 2) || ($store.getters.user.role.is_consultant == 1 && this.is_upgraded_consultant == true)">
...
export default {
  ...
  methods: {
    ...
    async checkConsultantUpgrade() {
        ...
        if(data.is_upgraded == false && $store.getters.user.role.is_consultant == 1) {
          this.tabId = 'consultation';        
        }
