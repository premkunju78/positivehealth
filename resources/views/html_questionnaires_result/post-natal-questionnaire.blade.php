                ...
                <section id="step_1">
                  ...
                  <div class="form-group row">
                    <div class="col-md-12 col-lg-12 col-sm-12">
                      ...
                      <p>{{ $result['labour_description'] ?? '-' }}</p>
                    </div>
                  </div>
                  <div class="form-group row">
                    <div class="col-md-12 col-lg-12 col-sm-12">
                      <label class="control-label">Are you or your baby presently on any medication? 
                      <p>{{ $result['baby_on_medication'] ?? '-' }}</p>
                 Please give details</label>
                 <p>{{ $result['baby_on_medication_details'] ?? '-' }}</p>
                    </div>
                  </div>
                  <div class="form-group row">
                    <div class="col-md-12 col-lg-12 col-sm-12">
                      <label class="control-label">Did your baby require any special care
                      <p>{{ $result['baby_require_care'] ?? '-' }}</p>
                        Please give details</label>
                        <p>{{ $result['baby_require_care_details'] ?? '-' }}</p>
                    </div>
                  </div>
                  <div class="form-group row">
                    <div class="col-md-12 col-lg-12 col-sm-12">
                      <label class="control-label">Does your baby have any medical condition we should be aware of?</label>
                      <p>{{ $result['baby_have_medicatiom'] ?? '-' }}</p>
                    </div>
                  </div>
                  <div class="form-group row">
                    <div class="col-md-12 col-lg-12 col-sm-12">
                      ...
                      <p>{{ $result['details_of_complications'] ?? '-' }}</p>
                    </div>
                  </div>
                  <div class="form-group row">
                    <div class="col-md-12 col-lg-12 col-sm-12">
                      ...
                      <div class="row">
                      <?php
                        if (!empty($result['health_problems'])) {
                          foreach ($result['health_problems'] as $health_problems) { ?>
                            <div class="col-md-4 col-lg-4 col-sm-4">
                              <p><?php echo $health_problems; ?></p>
                            </div>
                        <?php }
                        }
                        ?>
                ...
                <section id="step_2">
                  <div class="form-group row">
                    <div class="col-md-4 col-lg-4 col-sm-4">
                      ...
                      <p>{{ $result['labour_length'] ?? '-' }} hrs</p>
                    </div>
                  </div>
                  <div class="form-group row">
                    <div class="col-md-12 col-lg-12 col-sm-12">
                      <label class="control-label">2. Was labour self starting 
                      <p>{{ $result['labourself_starting'] ?? '-' }}</p>
</label>
                  ...
                  <div class="form-group row">
                    <div class="col-md-12 col-lg-12 col-sm-12">
                      <label class="control-label">3. Nature of delivery
                      <p>{{ $result['nature_of_delivery'] ?? '-' }}</p>
</label>
<p>{{ $result['nature_of_delivery_details'] ?? '-' }}</p>
                  ...
                  <div class="form-group row">
                    <div class="col-md-12 col-lg-12 col-sm-12">
                      ...
                      <p>{{ $result['delivery_environment'] ?? '-' }}</p>
                  ...
                  <div class="form-group row">
                    <div class="col-md-12 col-lg-12 col-sm-12">
                      ...
                      <p>{{ $result['postpartum_hemorrhage'] ?? '-' }}</p>
